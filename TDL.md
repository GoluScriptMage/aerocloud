## Level - 1 (Basic level MVP)

Day 1 - created archiever and setup project and fixes esm and type errors
Day 2 - finsihed mvp of aero deploy , Now can see the static website deployed on /deploy route
Day 3 - added list route to get deployed subdomains and their deployedAt timing and show in formatted way & fixed git config for bug 
